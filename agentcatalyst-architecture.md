...
Skill activation sequence (follow THIS, not the default agents-cli workflow):
 ...
 6. Generate FunctionTool implementations (google-agents-cli-adk-code)
...
| 6 | Generate FunctionTool implementations from `tools.function_tools:` | `google-agents-cli-adk-code` |
...
- Report files for developer review (FunctionTool implementations with first-draft business logic)
- Report any warnings
