# Transcript — `/accelerator.blueprint` (CustomerOnboarding-ESB)

```
You: /accelerator.blueprint

Agent: Blueprint generation started (task bpf-df3e47bfd9aa6526). Checking progress...
...
Agent: Stage ⑤: pattern retrieval for INT-004 (cross-cloud)...
