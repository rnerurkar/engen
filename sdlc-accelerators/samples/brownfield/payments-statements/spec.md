> **Lineage:** seeded from Rally Epic `E6105` @ ObjectVersion `9` via `/accelerator.ingest-epic` (see `epic-signal-ledger.json`), then reviewed and completed into this spec.
